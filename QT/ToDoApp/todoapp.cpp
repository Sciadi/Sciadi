...
void ToDoApp::initStyleSheet() {

    // You have to create the css file first in the main project directory

    // Get the css file
    QDir appDir(QCoreApplication::applicationDirPath());
    QString parentFolder = appDir.absolutePath();
    QFile style(parentFolder +"\\style_Generic.css");
...
void ToDoApp::createNewTask(QString taskName, QString date) {
